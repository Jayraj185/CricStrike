                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            Expanded(
                                child: Text(
                              "Thus, the IPL pitch report on every match day will become extremely crucial. It will be crucial not only for the teams playing the match but also for the fans across the world that indulge in fantasy cricket. The reports will help them choose the players according to the average score on that pitch and the ability of the teams to reach that score.",
                            )),
                          ],
                        ),
                        SizedBox(
